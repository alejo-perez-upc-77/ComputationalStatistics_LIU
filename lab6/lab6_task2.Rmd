...
$$ln({l}(\lambda|Y,Z))= 2\sum_{i=1}^{n} X_i -2nln(2\lambda) - \frac{1}{\lambda}\sum_{i=1}^n[X_i.Y_i +\sum_{i=1}^r \frac{X_i.Z^o_i}{2}+ \sum_{i=r+1}^n \frac{X_i. Z^u_i}{2})]$$ 
...
$$Q(\lambda, \lambda^k)= 2\sum_{i=1}^n X_i - 2nln(2 \lambda) - \frac{1}{\lambda}(\sum_{i=1}^n X_i. Y_i  + \sum_{i=1}^r \frac{X_i Z^o_i}{2} + \sum_{i=r+1}^n \lambda^k) $$
